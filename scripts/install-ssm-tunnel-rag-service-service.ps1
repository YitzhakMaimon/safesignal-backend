# Registers ssm-tunnel-rag-service-loop.ps1 as a Windows Scheduled Task that
...
$taskName = "SafeSignal-SSM-Tunnel-RagService"
$scriptPath = "C:\Users\yitzhama\projects\final_project_safesignal\scripts\ssm-tunnel-rag-service-loop.ps1"
